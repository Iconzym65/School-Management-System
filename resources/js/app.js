                ...
                <div className="fixed inset-0 z-40 flex items-center justify-center bg-slate-900/60 p-4">
                    ...
                    <div className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-2xl">
                        ...
                        <div className="mb-4 flex items-center justify-between">
                            ...
                            <button onClick={() => setShowTeacherModal(false)} className="text-xl text-slate-500">ÃÂÃÂ</button>
                ...
                <div className="fixed inset-0 z-40 flex items-center justify-center bg-slate-900/60 p-4">
                    ...
                    <div className="w-full max-w-2xl rounded-2xl bg-white p-6 shadow-2xl">
                        ...
                        <div className="mb-4 flex items-center justify-between">
                            ...
                            <button onClick={() => setShowCourseModal(false)} className="text-xl text-slate-500">ÃÂÃÂ</button>
                ...
                <div className="fixed inset-0 z-40 flex items-center justify-center bg-slate-900/60 p-4">
                    ...
                    <div className="w-full max-w-2xl rounded-2xl bg-white p-6 shadow-2xl">
                        ...
                        <div className="mb-4 flex items-center justify-between">
                            ...
                            <button onClick={() => setShowTimetableModal(false)} className="text-xl text-slate-500">ÃÂÃÂ</button>
                                ...
                                <div>
                                    ...
                                    <select value={timetableForm.course_id} onChange={(event) => setTimetableForm({ ...timetableForm, course_id: event.target.value })} className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm" required>
                                        ...
                                        {courses.map((course) => (
                                            ...
                                            <option key={course.id} value={course.id}>{course.code} ÃÂ¢ÃÂÃÂ {course.title}</option>
